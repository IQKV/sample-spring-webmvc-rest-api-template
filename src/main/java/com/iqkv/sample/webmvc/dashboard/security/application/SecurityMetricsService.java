...
/**
 * Application service for tracking security-related metrics.
 * This service is part of the Security bounded context and handles
 * monitoring and observability concerns for authentication and authorization.
 */
@Service
