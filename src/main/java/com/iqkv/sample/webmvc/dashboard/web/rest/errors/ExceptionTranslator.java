...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
  ...
  private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
    if (
        ex instanceof com.iqkv.sample.webmvc.dashboard.service.UsernameAlreadyUsedException
    ) {
      return (ProblemDetailWithCause) new LoginAlreadyUsedException().getBody();
    }
    if (
        ex instanceof com.iqkv.sample.webmvc.dashboard.service.EmailAlreadyUsedException
    ) {
      return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
    }
    if (
        ex instanceof com.iqkv.sample.webmvc.dashboard.service.InvalidPasswordException
    ) {
  ...
  private boolean containsPackageName(String message) {
    ...
    return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.iqkv.sample.webmvc.dashboard");
  }
}
