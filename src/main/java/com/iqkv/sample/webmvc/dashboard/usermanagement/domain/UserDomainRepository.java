...
public interface UserDomainRepository {
  ...
  /**
   * Finds unactivated users since the given date.
   *
   * @param since the cutoff date
   * @return list of unactivated users
   */
  List<User> findUnactivatedUsersSince(Instant since);

  /**
   * Finds users with expired password reset tokens.
   *
   * @param expiredBefore the expiration cutoff date
   * @return list of users with expired password reset
   */
  List<User> findUsersWithExpiredPasswordReset(Instant expiredBefore);
}
