...
/**
 * Global controller advice to translate server side exceptions to client-friendly json structures.
...
public class GlobalExceptionTranslator extends ResponseEntityExceptionHandler {
  ...
  public GlobalExceptionTranslator(ClientApplicationProperties clientApplicationProperties, Environment env) {
  ...
  private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
    ...
    if (ex instanceof com.iqkv.sample.webmvc.dashboard.usermanagement.domain.exception.UsernameAlreadyUsedException) {
      return (ProblemDetailWithCause) new LoginAlreadyUsedException().getBody();
    }
    if (ex instanceof com.iqkv.sample.webmvc.dashboard.usermanagement.domain.exception.EmailAlreadyUsedException) {
      return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
    }
    if (ex instanceof com.iqkv.sample.webmvc.dashboard.usermanagement.domain.exception.InvalidPasswordException) {
