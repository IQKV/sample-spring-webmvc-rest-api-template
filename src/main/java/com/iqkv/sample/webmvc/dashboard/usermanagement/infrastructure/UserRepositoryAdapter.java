...
public class UserRepositoryAdapter implements UserDomainRepository {
  ...
  @Override
  public List<User> findUnactivatedUsersSince(Instant since) {
    return userRepository.findAllByActivatedIsFalseAndCreatedDateAfter(since);
  }

  @Override
  public List<User> findUsersWithExpiredPasswordReset(Instant expiredBefore) {
    return userRepository.findAllByResetDateBefore(expiredBefore);
  }
