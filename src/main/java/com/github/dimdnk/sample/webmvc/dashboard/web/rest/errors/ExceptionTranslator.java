...
package com.github.dimdnk.sample.webmvc.dashboard.web.rest.errors;
...
import com.github.dimdnk.boot.info.InfoConstants;
import com.github.dimdnk.boot.mvc.rest.HeaderUtil;
import com.github.dimdnk.boot.mvc.rest.errors.DataErrorConstants;
import com.github.dimdnk.boot.mvc.rest.errors.FieldErrorVM;
...
import com.github.dimdnk.boot.security.errors.InvalidPasswordException;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
  ...
  private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
    if (
        ex instanceof com.github.dimdnk.sample.webmvc.dashboard.service.UsernameAlreadyUsedException
    ) {
      return (ProblemDetailWithCause) new LoginAlreadyUsedException().getBody();
    }
    if (
        ex instanceof com.github.dimdnk.sample.webmvc.dashboard.service.EmailAlreadyUsedException
    ) {
      return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
    }
    if (
        ex instanceof com.github.dimdnk.sample.webmvc.dashboard.service.InvalidPasswordException
    ) {
  ...
  private boolean containsPackageName(String message) {
    ...
    return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.github.dimdnk.sample.webmvc.dashboard");
  }
}
