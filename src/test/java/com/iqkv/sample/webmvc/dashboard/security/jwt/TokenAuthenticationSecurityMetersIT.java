...
import static com.daromir.boot.security.jwt.JwtAuthenticationTestUtils.createInvalidToken;
...
class TokenAuthenticationSecurityMetersIT {
  ...
  @Value("${application-settings.security.authentication.jwt.base64-secret}")
